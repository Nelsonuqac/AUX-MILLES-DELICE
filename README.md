# AUX-MILLES-DELICE
Site Web aux milles delice: Restaurant de cuisine africaine authentique a paris depuis 2010.
# Aux mille délices
...
- Aucun serveur ou installation supplémentaire requis

### Installation

1. **Clonez ou téléchargez le dépôt** :
   ```bash
   git clone https://github.com/votre-nom/aux-mille-delices.git
   ```

2. **Naviguez dans le dossier du projet** :
   ```bash
   cd aux-mille-delices
   ```
